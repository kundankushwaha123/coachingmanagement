    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="index.php" aria-expanded="false">
                ...
                <!-- <li><a href="all-enrolledstudent.php">all Enrolled Student</a></li> -->
            </li>
            ...
            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="all-enrollment.php">All Enrollment</a></li>
                    <li><a href="add-enrollment.php">Add Enrollment</a></li>
                </ul>
            </li>
            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
            ...
            <li class="ui-menu"><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
