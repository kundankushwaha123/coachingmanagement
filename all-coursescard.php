        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="images/courses/pic5.jpg" alt="">
							<div class="card-body">
								<h4>When Is the Best Time to Take an Education Course?</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="images/courses/pic6.jpg" alt="">
							<div class="card-body">
								<h4>Education Courses: A Guide to Unlocking Your Potential</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="images/courses/pic7.jpg" alt="">
							<div class="card-body">
								<h4>A Comprehensive Guide to Taking an Education Course</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
							<img class="img-fluid rounded-top" src="images/courses/pic8.jpg" alt="">
							<div class="card-body">
								<h4>Why Should You Consider Taking an Education Course?</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0">April 23</span>
