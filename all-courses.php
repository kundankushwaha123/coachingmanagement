				...
				<div class="row page-titles mx-0">
					...
					<div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><a href="add-courses.php">All Courses</a></li>
						</ol>
					</div>
				</div>
							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">All Coursed List </h4>
										...
										<div class="table-responsive">
											<table id="example3" class="display text-nowrap" style="min-width: 845px">
												...
												<tbody>
													...
													$coursesqey = mysqli_query($con, "SELECT * FROM courses");

													if ($coursesqey) {
														while ($courseData = mysqli_fetch_assoc($coursesqey)) {
													...
													?>
															<tr>
																...
																<td>
																	<img src="media/courses-image/<?= $courseData['image'] ?>" alt="profile"
																		class="rounded-circle" width="40" height="40">
																</td>
																<td><?= $courseData['name'] ?></td>
																<td><?= $courseData['price'] ?></td>
																<td><?= $courseData['teacher'] ?></td>
																<td><?= $courseData['startingfrom'] ?></td>
																<td><?= $courseData['duration'] ?></td>
																<td><?= $courseData['status'] ?></td>
																<td>
																	<a href="about-courses.php?course_id=<?= $course_id ?>"
																		class="btn btn-xs sharp btn-warning"><i
																			class="fa fa-eye"></i></a>
																	<a href="add-courses.php?course_id=<?= $course_id ?>"
